...
- บริการกายภาพบำบัด
- บริการทันตกรรม
- จุดรับบริการอุบัติเหตุฉุกเฉิน (มีรายการใน `er_regist`)
- จุดรับบริการผู้ป่วยนอก

การจัดหมวดบริการตรวจจากชื่อรายการค่าบริการและหมวดรายได้ในใบสั่ง HOSxP ของแต่ละ visit

หน้าจอสิทธิ์ข้าราชการรองรับเป้าหมายรายเดือนแยกตามหมวดบริการและสิทธิ์รวม 10 ชุด โดยกำหนดได้ทั้งจำนวน visit และยอดเงิน จะเปิดใช้อย่างใดอย่างหนึ่งหรือทั้งสองอย่างก็ได้ ค่าเริ่มต้นคือ `120 visit` ต่อหมวด/สิทธิ์ ข้อมูลเป้าหมายบันทึกใน `data/civil-service-targets.json`
